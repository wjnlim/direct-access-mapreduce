...
# cmd="$DIRECT_ACCESS_MR_HOME/bin/worker $worker_name $worker_ip \
# $DIRECT_ACCESS_MR_HOME/mapred_bin $DIRECT_ACCESS_MR_HOME/sharedfiles $DIRECT_ACCESS_MR_HOME/mnt $worker_dev"
cmd="$DIRECT_ACCESS_MR_HOME/bin/worker $worker_name $worker_ip $worker_dev"
